...
class SaudaExtensionDetailScreen extends StatelessWidget {
  ...
  static Route route() {
    return MaterialPageRoute(settings: const RouteSettings(name: routeName), builder: (_) => const SaudaExtensionDetailScreen());
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => SaudaExtensionDetailBloc()
        ..add(LoadSaudaExtensionDetailScreen(userId: Constants.AUTH_USERID, fromDate: "", toDate: ""))
        ..add(LoadNewSaudaExtensionScreen(userId: Constants.AUTH_USERID, salesOrganizationId: 0, distributionChannelId: 0, divisonId: 0))
...
class _SaudaExtensionDetailsState extends State<SaudaExtensionDetails> {
        ...
        listener: (context, state) {
          if (state is OnLoadSuccess) {
            ...
            if (Constants.ZHMANAGER == Constants.AUTH_ROLEID) {
              BlocProvider.of<SaudaExtensionDetailBloc>(context).add(LoadBdo(userId: Constants.AUTH_USERID));
            }
            setState(() {});
          }
            ...
            if (Constants.ZHMANAGER == Constants.AUTH_ROLEID) {
              if (_dialogKey.currentState != null) {
                _dialogKey.currentState!.setState(() {
                  selectedDistributor = null;
                  if (state.distributorList.isNotEmpty) {
                    selectedDistributor = state.distributorList[0];
                  }
          ...
          if (state is OnSaveSuccess) {
            showSuccessDlg(context, "Extension Saved Successfully", "Sauda Extension", successText: "Sauda Extension Saved Successfully");
          }
                    ...
                    SingleChildScrollView(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                  height: selectedCount > 0 ? screenHeight * 0.900 : screenHeight * 0.950,
                                  width: screenWidth,
                                  child: CurveBorderBox(
                                    ...
                                    boxofWidget: Column(
                                      ...
                                      children: [
                                                      ...
                                                      Expanded(
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            CommonText(
                                                              name: pendingCount.toString() + " SKU",
                                                              fontSize: Constant.fontSize13,
                                        ...
                                        Container(
                                          height: selectedCount > 0 ? screenHeight * 0.780 : screenHeight * 0.800,
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  Align(
                                                    ...
                                                    child: CommonText(
                                                        name: selectedCount.toString() + " Selected ",
                                                        fontColor: Constant.colorDullGray77,
                                              ...
                                              Container(
                                                height: selectedCount > 0 ? screenHeight * 0.570 : screenHeight * 0.640,
                                                child: ListView.builder(
                                                  ...
                                                  itemBuilder: (context, index) {
                                                    return InkWell(
                                                        onTap: () {
                                                          saudaDetails[index].isExpanded = !saudaDetails[index].isExpanded!;
                                                          setState(() {});
                                                        },
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                        children: [
                                                                          Expanded(
                                                                            child: Text(
                                                                              "#" + saudaDetails[index].saudaNumber!,
                                                                          ...
                                                                          Align(
                                                                              ...
                                                                              child: Checkbox(
                                                                                onChanged: (bool? value) {
                                                                                  saudaDetails[index].isSelected = value!;
                                                                                  getSelectedCount();
                                                                                  setState(() {});
                                                                                },
                                                                                value: saudaDetails[index].isSelected,
                                                                                activeColor: Colors.green[600],
                                                                              ))
                                                                        ],
                                                                      )
                                                                  ...
                                                                  children: [
                                                                    Row(
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                            (saudaDetails[index].saudaValidFromDate != null || saudaDetails[index].saudaBookedDate != null)
                                                                          ...
                                                                          child: Align(
                                                                            ...
                                                                            child: Column(
                                                                              children: [
                                                                                Text(
                                                                                  DateTimeUtils().dateToServerToDateFormat(
                                                                                      saudaDetails[index].saudaValidToDate == null
                                                                                          ? saudaDetails[index].saudaBookedDate!
                                                                                ...
                                                                                Text(
                                                                                  ...
                                                                                  style: TextStyle(fontSize: Constant.fontSize11, color: Constant.colorGray75),
                                                                                ),
                                                                              ],
                                                                            ),
                                                                          ),
                                                                        ...
                                                                        Expanded(
                                                                          child: SizedBox(
                                                                            ...
                                                                            child: Align(
                                                                                ...
                                                                                child: InkWell(
                                                                                    onTap: () {
                                                                                      showCustomAlertDialog(context, contBody(), 'Extension Period', {},
                                                                                          hideCancelBtn: true, sauda: saudaDetails[index]);
                                                                                    },
                                                                                    child: CommonLabel(
                                                                                      bgColor: Constant.colorOrange,
                                                                                      name: saudaDetails[index].extendedDays == null
                                                                                          ? saudaDetails[index].saudaExtendedDays.toString()
                                                                                          : saudaDetails[index].extendedDays.toString() + " days",
                                                              ...
                                                              Visibility(
                                                                  visible: saudaDetails[index].isExpanded!,
                                                                  child: Container(
                                                                                        ...
                                                                                        children: [
                                                                                          Expanded(
                                                                                            child: Text(
                                                                                              ...
                                                                                              style: TextStyle(
                                                                                                  fontSize: Constant.fontSize14, color: Constant.colorBlack, fontWeight: Constant.fontWeight500),
                                                                                            ),
                                                                                          ),
                                                                                        ],
                                                                                      )
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: CommonButton(
                                ...
                                buttonFunction: () {
                                  showRemarksDialog(context, {}, 'Save Extension', dialogActionButton(), hideCancelBtn: true);
                                },
                              ),
                            ),
                          ],
  ...
  void showCustomAlertDialog(BuildContext context, messageValue, title, footerbutton,
      {bool? hideCancelBtn = false, String? successText = 'OK', Color? titleColor = Colors.white, SaudaExtension? sauda}) {
    // set up the button
    ...
    if (sauda.extendedToDate != null) {
      _datecontroller.text = DateTimeUtils().dateToServerToDateFormat(sauda.extendedToDate!, DateTimeUtils.YYYY_MM_DD_Format, DateTimeUtils.DD_MM_YYYY_Format);
    } else {
      _datecontroller.text = DateTimeUtils()
          .dateToServerToDateFormat(sauda.saudaExtendedToDate == null ? sauda.saudaValidFromDate! : sauda.saudaExtendedToDate!, DateTimeUtils.YYYY_MM_DD_Format, DateTimeUtils.DD_MM_YYYY_Format);
    }
    // show the dialog
    showDialog(
      context: context,
          ...
          return AlertDialog(
            ...
            content: Container(
              ...
              child: SingleChildScrollView(
                ...
                children: [
                  CommonTextFormField(
                      labeltxt: "Extension Day (Max:" + sauda.saudaExtendedDays! + " )",
                      ...
                      onChanged: (String? value) {
                        ...
                        if (sauda.saudaExtendedDays != null) {
                          maxDays = int.parse(sauda.saudaExtendedDays!.replaceAll("days", ""));
                        }
                        if (value != null && value != "" && int.parse(value) > maxDays) {
                          if (sauda.saudaExtendedDays != null) {
                            _daycontroller.text = sauda.saudaExtendedDays!.replaceAll("days", "");
                          } else {
                        ...
                        _datecontroller.text = DateTimeUtils().dateToStringFormat(
                            DateTimeUtils()
                                .stringToDate(sauda.saudaExtendedToDate == null ? sauda.saudaValidToDate! : sauda.saudaExtendedToDate!, DateTimeUtils.YYYY_MM_DD_Format)
                                .add(Duration(days: (maxDays - days) * -1)),
                            DateTimeUtils.DD_MM_YYYY_Format);
                        DateTime curDate = DateTimeUtils().stringToDate(sauda.saudaValidToDate!, DateTimeUtils.YYYY_MM_DD_Format);
                        // .add(Duration(
                        //     days: 1));
                        ...
                        _datecontroller.text = DateTimeUtils().dateToStringFormat(curDate, DateTimeUtils.DD_MM_YYYY_Format);
                      }),
                  ...
                  CommonTextFormField(
                      ...
                      inputFormatter: <TextInputFormatter>[FilteringTextInputFormatter.allow(RegExp(r'^\d+\.?\d{0,2}'))],
                      onChanged: (String? value) {}),
                  const SizedBox(height: 16.0),
                ],
              )),
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: CommonButton(
                            ...
                            buttonFunction: () {
                              if (_daycontroller.text.toString() != "") {
                                sauda.extendedDays = int.parse(_daycontroller.text.toString());
                                sauda.extendedToDate = DateTimeUtils().dateToServerToDateFormat(_datecontroller.text.toString(), DateTimeUtils.DD_MM_YYYY_Format, DateTimeUtils.YYYY_MM_DD_Format);
                              }
                              Navigator.pop(context);
                            },
                          ),
  ...
  void showRemarksDialog(BuildContext context, messageValue, title, footerbutton, {bool? hideCancelBtn = false, String? successText = 'OK', Color? titleColor = Colors.white}) {
    // set up the button
              ...
              buttonFunction: () {
                ...
                for (SaudaExtension s in saudaDetails) {
                  if (s.isSelected!) {
                    ...
                    extension.requestDate = s.extendedToDate == null ? s.saudaExtendedToDate! : s.extendedToDate.toString();
                    ...
                    extension.extentionDateCount = s.extendedDays ?? int.parse((s.saudaExtendedDays == null ? "0" : s.saudaExtendedDays!.replaceAll("days", "")));
                    request.saudaExtensionList!.add(extension);
                  }
                }
                BlocProvider.of<SaudaExtensionDetailBloc>(context).add(SaveSaudaExtension(request: request));
                Navigator.pop(context);
              },
            ),
          ),
        ...
        Row(
          ...
          children: [
            CommonButton(
                ...
                buttonFunction: () {
                  Navigator.pop(context);
                  BlocProvider.of<SaudaExtensionDetailBloc>(context).add(LoadSaudaExtensionDetailScreen(userId: Constants.AUTH_USERID, fromDate: "", toDate: ""));
                })
          ],
        )
      ],
  ...
  Widget getDialogContent() {
    ...
    return Column(mainAxisSize: MainAxisSize.min, children: [
      Visibility(
          visible: Constants.ZHMANAGER == Constants.AUTH_ROLEID,
          child: SizedBox(
              width: double.infinity,
              child: CommonDropdownButtonFormField<BdoList>(
                ...
                onChanged: (BdoList? newValue) {
                  ...
                  BlocProvider.of<SaudaExtensionDetailBloc>(ctx)
                      .add(LoadNewSaudaExtensionScreen(userId: Constants.AUTH_USERID, salesOrganizationId: 0, distributionChannelId: 0, divisonId: 0, bdoId: selectedBdo!.id!));
                },
        ...
        return StatefulBuilder(
            ...
            builder: (context, setState) {
              return AlertDialog(
                ...
                content: Container(
                    height: Constants.ZHMANAGER == Constants.AUTH_ROLEID ? 220 : 170, width: double.infinity, padding: const EdgeInsets.only(left: 10, right: 10, top: 20), child: getDialogContent()),
                actions: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [footerbutton],
        ...
        children: [
          ...
          SizedBox(
            ...
            child: CommonButton(
              ...
              buttonBorder: Colors.transparent,
              buttonFunction: () {
                BlocProvider.of<SaudaExtensionDetailBloc>(ct).add(LoadSaudaExtensionDetailScreen(
                    userId: Constants.AUTH_USERID,
                    fromDate: "",
                    toDate: "",
                    bdoId: selectedBdo != null ? selectedBdo!.id! : 0,
                    oilTypeId: selectedOilType != null ? selectedOilType!.id! : 0,
                    dealerId: selectedDistributor != null ? selectedDistributor!.id! : 0));
                Navigator.pop(context);
              },
            ),
          ),
