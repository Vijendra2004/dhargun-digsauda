...
class UserDiscountScreen extends StatelessWidget {
  ...
  const UserDiscountScreen({Key? key}) : super(key: key);
                  ...
                  child: FloatingButton(
                      ...
                      navigationFunction: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => CreateDiscountScreen(
                                    isUpdate: false,
                                    id: 0,
                                    employeeIds: const [],
                                    materialIds: const [],
              ...
              body: BlocListener<CreateDiscountBloc, CreateDiscountState>(
                listener: (context, state) {
                  if (state is UserDiscountListRequestSuccess) {
                    ...
                    GMLogger.v(userDiscountRequestList);
                  }
                ...
                child: Stack(
                  children: [
                    ...
                    Container(
                      ...
                      width: screenWidth,
                      child:
                      (userDiscountRequestList.isNotEmpty)
                      ? CurveBorderBox(
                        boxLRPadding: 8,
                        boxTOPPadding: 0,
                        boxBOTPadding: 0,
                        boxofWidget: ListView.builder(
                          ...
                          itemCount: userDiscountRequestList.length,
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                      ...
                                      id: userDiscountRequestList[index].id,
                                      fromDate: userDiscountRequestList[index]
                                          .validFrom,
                                      toDate: userDiscountRequestList[index]
                                          .validTo,
                                    ),
                                  ),
                                );
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (context) =>
                                                                  CreateDiscountScreen(
                                                                    ...
                                                                    id: userDiscountRequestList[index].id!,
                                                                    employeeIds:
                                                                        userDiscountRequestList[index]
                                                                            .customerId!,
                                                                    materialIds:
                                                                        userDiscountRequestList[index]
                                                                            .skuIds!,
                                                                    stateIds: userDiscountRequestList[index]
                                                                        .stateIds!,
                                                                    discount: userDiscountRequestList[index].actualDiscount.toString(),
                                                                    discountReason: userDiscountRequestList[index].discountReason.toString(),
                                                                    state: '',
                                                                    fromDate: userDiscountRequestList[index].validFrom.toString(),
                                                                    toDate: userDiscountRequestList[index].validTo.toString(),
                                                                    salesOrganizationId: 0,
                                                                    distributionChannelId: 0,
                                                                    divisionId: 0,
                                                                    stateId: 0,
