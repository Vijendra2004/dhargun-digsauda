...
class RequestQuantityTabBloc
    extends Bloc<RequestQuantityTabEvent, RequestQuantityTabState> {
  RequestQuantityTabBloc() : super(InitialRequestQuantityTabState()) {
  ...
  RequestQuantityTabState get initialState => InitialRequestQuantityTabState();

  Future<void> _getOilTypeData(
      LoadOilType event, Emitter<RequestQuantityTabState> emit) async {
    try {
  ...
  Future<void> _getOverallData(
      LoadOverallData event, Emitter<RequestQuantityTabState> emit) async {
    try {
      emit(ShowProgressBar());
  ...
  Future<void> _getQuantityRequestList(LoadQuantityAllocationRequest event,
      Emitter<RequestQuantityTabState> emit) async {
    try {
      emit(ShowProgressBar());
      Meta meta = await ServiceRepository()
  ...
  Future<void> _saveQuantityRequest(
      SaveQuantityRequest event, Emitter<RequestQuantityTabState> emit) async {
    try {
      emit(ShowProgressBar());
