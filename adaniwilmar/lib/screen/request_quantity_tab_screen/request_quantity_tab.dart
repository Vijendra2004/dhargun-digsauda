...
import 'package:adaniwilmar/screen/request_quantity_tab_screen/bloc/bloc.dart';
...
import '../requested_quantity_list/requested_qa_list_screen.dart';
import 'bloc/request_quantity_tab_bloc.dart';

class RequestQuantityTabScreen extends StatelessWidget {
  const RequestQuantityTabScreen({Key? key}) : super(key: key);
  static const String routeName = '/';
  static Route route() {
    return MaterialPageRoute(
        settings: const RouteSettings(name: routeName),
        builder: (_) => const RequestQuantityTabScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => RequestQuantityTabBloc()
        ..add(LoadOilType())
        ..add(LoadQuantityAllocationRequest(userId: Constants.AUTH_USERID)),
      child: const RequestQuantityTab(),
    );
  }
}

class RequestQuantityTab extends StatefulWidget {
  const RequestQuantityTab({Key? key}) : super(key: key);

  @override
  State<RequestQuantityTab> createState() => _RequestQuantityTabState();
}

class _RequestQuantityTabState extends State<RequestQuantityTab>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<RequestQuantityTabBloc, RequestQuantityTabState>(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: TabBarView(
                                  controller: tabController,
                                  children: [
                                    AssignedQAListScreen(true),
                                    const RequestedQAListScreen(),
                                  ],
                                ),
                              ),
                            ],
