...
abstract class DeviationApprovalState extends Equatable {
  const DeviationApprovalState();
  @override
  List<Object> get props => [];
}

class InitialDeviationApprovalState extends DeviationApprovalState {}

class ShowProgressBar extends DeviationApprovalState {}

class HideProgressBar extends DeviationApprovalState {}

class OnSuccess extends DeviationApprovalState {
...
class OnFailure extends DeviationApprovalState {
  final String error;
...
class OnOverallSuccess extends DeviationApprovalState {
...
class OnLoadSuccess extends DeviationApprovalState {
