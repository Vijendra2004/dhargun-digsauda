...
abstract class QuantityAllocationTabState extends Equatable {
  const QuantityAllocationTabState();
  @override
  List<Object> get props => [];
}

class InitialQuantityAllocationTabState extends QuantityAllocationTabState {}

class ShowProgressBar extends QuantityAllocationTabState {}

class HideProgressBar extends QuantityAllocationTabState {}

class OnSuccess extends QuantityAllocationTabState {
...
class OnFailure extends QuantityAllocationTabState {
  final String error;
...
class OnOverallSuccess extends QuantityAllocationTabState {
...
class OnOverallManagerSuccess extends QuantityAllocationTabState {
...
class OnLoadSuccess extends QuantityAllocationTabState {
...
class OnLoadOilType extends QuantityAllocationTabState {
...
class OnQuantityAllocationRequestSuccess extends QuantityAllocationTabState {
...
class OnSaveSuccess extends QuantityAllocationTabState {
  final bool saved;
