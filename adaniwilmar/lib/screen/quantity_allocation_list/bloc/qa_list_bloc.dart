...
class QAListBloc
    extends Bloc<QAListEvent, QAListState> {
  QAListBloc() : super(InitialQuantityAllocationCreateUpdateState()) {
  ...
  QAListState get initialState => InitialQuantityAllocationCreateUpdateState();


  // Future<void> _getOverallData(
  //     LoadOverallData event, Emitter<QAListState> emit) async {
  //   try {
 ...
 /* Future<void> _getQuantityRequestList(LoadQuantityAllocationCreateUpdateRequest event,
      Emitter<QAListState> emit) async {
    try {
      emit(ShowProgressBar());
      Meta meta = await ServiceRepository()
  ...
  /*Future<void> _saveQuantityRequest(
      SaveQuantityRequest event, Emitter<QAListState> emit) async {
    try {
      emit(ShowProgressBar());
  ...
  Future<void> _getDistributorData(
      LoadSalesOrganization event, Emitter<QAListState> emit) async {
    try {
      emit(ShowProgressBar());
  ...
  Future<void> _getDistributionChannelData(
      LoadDistributionChannel event, Emitter<QAListState> emit) async {
    try {
      emit(ShowProgressBar());
      Meta salesOrg =
  ...
  Future<void> _getVerticalData(
      LoadVerticalList event, Emitter<QAListState> emit) async {
    try {
      emit(ShowProgressBar());
      Meta salesOrg =
  ...
  Future<void> _getOilTypeData(
      OnLoadOilType event, Emitter<QAListState> emit) async {
    try {
      emit(ShowProgressBar());
  ...
  Future<void> _getSubCategory(
      OnLoadSubCategory event, Emitter<QAListState> emit) async {
    try {
      emit(ShowProgressBar());
      Meta salesOrg =
  ...
  Future<void> _getMaterialDropDown(
      OnLoadMaterialDDList event, Emitter<QAListState> emit) async {
    try {
      emit(ShowProgressBar());
      Meta meta =
  ...
  Future<void> _getZonalEmployeesList(
      LoadZonalEmployees event, Emitter<QAListState> emit) async {
  try {
      emit(ShowProgressBar());
