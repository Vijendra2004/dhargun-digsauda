...
class DealerVisitScreen extends StatelessWidget {
  int dealerId;
  int id;
  int mtpId;
  DealerVisitScreen(
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => DailySalesReportBloc()
        ...
        //     divisonId: 0)),
        ..add(LoadDealerVisitScreen(userId: Constants.AUTH_USERID)),
...
class DealerVisit extends StatefulWidget {
  int dealerId;
  int id;
  int mtpId;
  ...
  @override
  State<DealerVisit> createState() => _DealerVisitState();
}

class _DealerVisitState extends State<DealerVisit> {
  List<SaudaList> saudaList = [];
  List<OilType> oilTypeList = [];
  List<DealerVisitCompetitorUIModel> competitorModel = [];
  ...
  int currentIndex = 0;
  TextEditingController? _saudanumbercontroller;
  TextEditingController? _saudaremarkscontroller = TextEditingController();
  TextEditingController? _titlecontroller = TextEditingController();
  TextEditingController? _marketremarkscontroller = TextEditingController();
  TextEditingController? _competitorremarkscontroller = TextEditingController();

  TextEditingController? _productnamecontroller = TextEditingController();
  TextEditingController? _ratecontroller = TextEditingController();
  TextEditingController? _quantitycontroller = TextEditingController();

  static String _displayStringForOption(SaudaList option) =>
      option.saudaNumber!;
  SaudaList? selectedSaudaNumber;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<DailySalesReportBloc, DailySalesReportState>(
        listener: (context, state) {
          if (state is OnLoadDealerVisit) {
            saudaList = state.saudaList;
            addNewSKU();
            setState(() {});
          }
                          ...
                          boxofWidget: Column(
                              ...
                              children: [
                                ...
                                CustomAutocomplete<SaudaList>(
                                  ...
                                  optionsBuilder:
                                    ...
                                    if (textEditingValue.text == '') {
                                      return const Iterable<SaudaList>.empty();
                                    }
                                    return saudaList.where((SaudaList option) {
                                      return option.saudaNumber
                                          .toString()
                                          .toLowerCase()
                                  ...
                                  onSelected: (SaudaList selection) {
                                    FocusManager.instance.primaryFocus
                                        ?.unfocus();
                                    setState(() {
                                      selectedSaudaNumber = selection;
                                    });
                                  },
                                ),
                                ...
                                CommonTextFormField(
                                  ...
                                  controllerTxt: _saudaremarkscontroller,
                                ),
                              ]))),
                  Visibility(
                          ...
                          boxofWidget: Column(
                              ...
                              children: [
                                Align(
                                    alignment: Alignment.centerLeft,
                                    child: CommonText(
                                        name: "Marketing Scenario Details",
                                        fontSize: Constant.fontSize14,
                                        fontColor: Constant.colorBlack)),
                                SizedBox(
                                  height: 8,
                                ...
                                CommonTextFormField(
                                  ...
                                  contentPadHVer:
                                      Constant.textFormcontentPadHVer,
                                  controllerTxt: _titlecontroller,
                                ),
                                const SizedBox(height: 8),
                                CommonTextFormField(
                                  maxLine: 4,
                                  ...
                                  contentPadHVer:
                                      Constant.textFormcontentPadHVer,
                                  controllerTxt: _marketremarkscontroller,
                                ),
                              ]))),
                  Visibility(
                                                        ...
                                                        onTap: () async {
                                                          ...
                                                          if (pickedFile !=
                                                            ...
                                                            f.fileName =
                                                                pickedFile.name;
                                                            f.id = 1;
                                                            f.fileExtention = pickedFile
                                                                .name
                                                                .substring(pickedFile
                                                                        .name
                                                                        .lastIndexOf(
                                                                            ".") +
                                                                    1);
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(
                      width: screenWidth / 2.2,
                      child: CommonButton(
                        buttonName: currentIndex == 2 ? "Submit" : "Next",
                        buttonNameSize: Constant.pricbuttonNameSize,
                        buttonNameColor: Constant.pricbuttonTxtColor,
                        ...
                        buttonFunction: () {
                          if (currentIndex == 2) {
                            showConfirmDlg(
                                context,
                                "Confirm Price Discovery Request",
                                "Confirm Request");
                          } else {
                            if (currentIndex == 0) {
                              if (selectedSaudaNumber == null) {
                                showSuccessDlg(context, "Error", "Error",
                                    successText: "Select Sauda Number");
                                return;
                              }
                              if (_saudaremarkscontroller!.text.toString() ==
                                  "") {
                                showSuccessDlg(context, "Error", "Error",
                                    successText: "Enter remarks");
                                return;
                              }
                            } else if (currentIndex == 1) {
                              if (_titlecontroller!.text.toString() == "") {
                                showSuccessDlg(context, "Error", "Error",
                                    successText: "Enter Title");
                                return;
                              }
                              if (_marketremarkscontroller!.text.toString() ==
                                  "") {
                                showSuccessDlg(context, "Error", "Error",
                                    successText: "Enter Remarks");
                                return;
            ...
            child: CommonButton(
              ...
              buttonFunction: () {
                ...
                if (selectedEditIndex == -1) {
                  DealerVisitProductModel p = DealerVisitProductModel();
        ...
        Row(
          ...
          children: [
            ...
            CommonButton(
                ...
                buttonBorder: Colors.transparent,
                buttonFunction: () {
                  DealerVisitRequest request = DealerVisitRequest();
                  request.bdoCompetitorAddDto = [];
                  request.createdBy = Constants.AUTH_USERID;
                  int i = 1;
                  for (DealerVisitCompetitorUIModel m in competitorModel) {
                    ...
                    for (DealerVisitProductModel cm in m.products!) {
                  ...
                  AddPendingSaudaRemarksDto pendingSaudaRemarks =
                      AddPendingSaudaRemarksDto();
                  pendingSaudaRemarks.dealerId = widget.dealerId;
                  pendingSaudaRemarks.remarks =
                      _saudaremarkscontroller!.text.toString();
                  pendingSaudaRemarks.createdBy = Constants.AUTH_USERID;
                  pendingSaudaRemarks.saudaId = selectedSaudaNumber!.saudaId;
                  request.addPendingSaudaRemarksDto = [];
                  request.addPendingSaudaRemarksDto!.add(pendingSaudaRemarks);
                  AddMarketScenarioDto market = AddMarketScenarioDto();
                  market.dealerId = widget.dealerId;
                  market.remarks = _marketremarkscontroller!.text.toString();
                  market.title = _titlecontroller!.text.toString();
                  request.addMarketScenarioDto = [];
                  request.addMarketScenarioDto!.add(market);
                  BlocProvider.of<DailySalesReportBloc>(context)
                      .add(SaveDealerVisit(request: request));
                })
          ],
        )
      ],
  ...
  contBody() {}
  void addNewSKU() {
    DealerVisitCompetitorUIModel model = DealerVisitCompetitorUIModel();
    // DealerVisitProductModel cm = DealerVisitProductModel();
    model.products = [];
    model.fileList = [];
